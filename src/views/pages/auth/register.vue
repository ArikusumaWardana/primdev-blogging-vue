...
const register = async () => {
  if (inputData.confirm_password == inputData.password) {
    ...
    try {
      const response = await axios.post('https://primdev.alwaysdata.net/api/register', inputData);
...
<template>
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
        <form @submit.prevent="register" action="" method="post" class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
